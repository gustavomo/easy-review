...
```bash
INIT=$(node "/Users/gustavo.moreno/Documents/personal info/easy-review/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/Users/gustavo.moreno/Documents/personal info/easy-review/.codex/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
